...
describe("HtmlExport", function() {
  ...
  it("can export Argdown", function() {
    ...
    expect(result.html).to.equal(
      `<!doctype html><html lang="en"><head><meta charset="utf8"><title>Title</title><link rel="stylesheet" href="./argdown.css"></head><body><div class="argdown"><h1 data-line="1" id="heading-title" class="has-line heading">Title</h1><div data-line="3" class="statement has-line"><span id="statement-statement" class="definition statement-definition definiendum">[<span class="title statement-title">Statement</span>]: </span>Hello World!<div class="relations"><div data-line="4" class="has-line outgoing support relation"><div class="outgoing support relation-symbol"><span>+</span></div><a href="#argument-argument" data-line="4" class="has-line reference argument-reference">&lt;<span class="title argument-title">Argument</span>&gt; </a></div></div></div><span id="argument-argument" class="definition argument-definition definiendum">&lt;<span class="title argument-title">Argument</span>&gt;: </span>Description 1 &lt; 2</div></body></html>`
    );
  });
