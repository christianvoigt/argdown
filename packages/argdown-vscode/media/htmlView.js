...
function scrollToRevealSourceLine(line) {
    if (!(0, settings_1.getSettings)().scrollPreviewWithEditor) {
        return;
    }
    if (line <= 0) {
...
(0, menu_1.initMenu)(messagePoster);
...
document.addEventListener("dblclick", event => {
    ...
    const line = (0, scroll_sync_1.getEditorLineNumberForPageOffset)(offset, store.getState().html.lineCount || 0);
...
if (settings.scrollEditorWithPreview) {
    window.addEventListener("scroll", throttle(() => {
        if (scrollDisabled) {
            ...
            const line = (0, scroll_sync_1.getEditorLineNumberForPageOffset)(window.scrollY, store.getState().html.lineCount || 0);
            if (typeof line === "number" && !isNaN(line)) {
