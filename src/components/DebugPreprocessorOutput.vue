<template>
  ...
  <h3>Statements</h3>
  <table>
  <tr class="statement" v-for="key in Object.keys($store.getters.statements)">
  ...
  <h3>Arguments</h3>
  <table>
  <tr class="argument" v-for="key in Object.keys($store.getters.arguments)">
  ...
  <h3>Relations</h3>
  <table>
  <tr class="relation" v-for="relation in $store.getters.relations">
